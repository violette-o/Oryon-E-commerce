...
const alsoViewed: CardData[] = [
  { name: 'MacBook Pro M2',        price: '$5.200.000 COP', img: imgMbpSilver,  alt: 'Iphone 15 Pro Max', badge: 'SAVE 12%' },
  { name: 'Portatil MSI Thin Amd', price: '$3.800.000 COP', img: imgMsiLaptop,  alt: 'Iphone 15'                            },
  { name: 'APPLE Ipad mini 256gb', price: '$2.200.000 COP', img: imgIpadMini,    alt: 'APPLE iPad mini'                      },
  { name: 'MSI Cyborg 15 A13VFF',  price: '$5.299.999 COP', img: imgMsiLaptop2,   alt: 'MSI Laptop'                           },
]
  ...
  return (
    <div className="product-card">
      ...
      <div className="product-card-body">
        ...
        <button className="btn-cart-small" aria-label="Add to cart">
          <ShoppingBag size={16} />
        </button>
      </div>
    </div>
...
function Carousel({ items }: { items: CardData[] }) {
  ...
  const goTo = (newIndex: number) => {
    ...
    trackRef.current.scrollLeft = newIndex * cardWidth
    setIndex(newIndex)
  }
  ...
  return (
    <div className="carousel-wrapper">
      ...
      <div ref={trackRef} className="carousel-track">
        {items.map(c => <ProductCard key={c.name} card={c} />)}
      </div>
      {index < max && (
